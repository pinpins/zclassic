...
BOOST_AUTO_TEST_CASE(get_next_work_buttercup)
{
    const Consensus::Params& params = RegtestActivateButtercup(true);
...
BOOST_AUTO_TEST_CASE(get_next_work_pow_limit_buttercup)
{
    const Consensus::Params& params = RegtestActivateButtercup(true);
...
BOOST_AUTO_TEST_CASE(get_next_work_lower_limit_actual_buttercup)
{
    const Consensus::Params& params = RegtestActivateButtercup(true);
...
BOOST_AUTO_TEST_CASE(get_next_work_upper_limit_actual_buttercup)
{
    const Consensus::Params& params = RegtestActivateButtercup(true);
...
BOOST_AUTO_TEST_CASE(GetBlockProofEquivalentTime_test_buttercup)
{
    GetBlockProofEquivalentTimeImpl(RegtestActivateButtercup(true));
    RegtestDeactivateButtercup();
}
